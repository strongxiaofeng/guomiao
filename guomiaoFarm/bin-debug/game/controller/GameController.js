...
var GameController = (function () {
    function GameController() {
        ...
        this.serverAddress = "http://60.205.229.120";
    }
    ...
    GameController.prototype.getStoreInfo = function () {
        ...
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=user/item-list', function (obj) {
            if (obj.status > 0) {
    ...
    GameController.prototype.getFarmInfo = function () {
        var sendData = { token: GameModel.getInstance().getToken() };
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=farm/land-list', function (obj) {
            if (obj.status > 0) {
    ...
    GameController.prototype.sendSeed = function (itemId) {
        ...
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=farm/sow-seeds', function (obj) {
    ...
    GameController.prototype.sendGather = function () {
        var sendData = { token: GameModel.getInstance().getToken() };
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=farm/gather-crop', function (obj) {
    ...
    GameController.prototype.sendSteal = function (userid) {
        ...
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=farm/steal', function (obj) {
    ...
    GameController.prototype.sendOperLand = function (type) {
        ...
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=farm/oper-land', function (obj) {
    ...
    GameController.prototype.sendWaterOtherLand = function (userid) {
        ...
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=farm/oper-other-land', function (obj) {
    ...
    GameController.prototype.getOrderList = function (status, offset, page_count) {
        ...
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=store/get-order-list', function (obj) {
            if (obj.status > 0) {
    ...
    GameController.prototype.sendOrder = function (address_id, item_list, user_message) {
        ...
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=store/order', function (obj) {
    ...
    GameController.prototype.sendOrderPay = function (order_id) {
        ...
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=store/pay', function (obj) {
    ...
    GameController.prototype.sendSureReceive = function (order_id) {
        var sendData = { order_id: order_id, token: GameModel.getInstance().getToken() };
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=store/receive', function (obj) {
    ...
    GameController.prototype.sendDeleteReceivedOrder = function (order_id) {
        var sendData = { order_id: order_id, token: GameModel.getInstance().getToken() };
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=store/del', function (obj) {
    ...
    GameController.prototype.sendSign = function () {
        var sendData = { token: GameModel.getInstance().getToken() };
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=user/sign', function (obj) {
    ...
    GameController.prototype.getSignList = function () {
        var sendData = { token: GameModel.getInstance().getToken() };
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=user/sign-list', function (obj) {
            if (obj.status > 0) {
    ...
    GameController.prototype.getContinueSignReward = function (count) {
        ...
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=user/get-continue-sign-gift', function (obj) {
    ...
    GameController.prototype.getAnnounceList = function (offset, page_count) {
        ...
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=comm/get-notice-list', function (obj) {
            if (obj.status > 0) {
    ...
    GameController.prototype.getAddressList = function () {
        var sendData = { token: GameModel.getInstance().getToken() };
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=user/get-address-list', function (obj) {
            if (obj.status > 0) {
    ...
    GameController.prototype.addAddress = function (realname, phone, address) {
        ...
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=user/add-address', function (obj) {
    ...
    GameController.prototype.editAddress = function (id, realname, phone, address) {
        ...
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=user/edit-address', function (obj) {
    ...
    GameController.prototype.deleteAddress = function (id) {
        ...
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=user/del-address', function (obj) {
            GameController.getInstance().getAddressList();
    ...
    GameController.prototype.setDefaultAddress = function (id) {
        var sendData = { id: id, token: GameModel.getInstance().getToken() };
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=user/default-address', function (obj) {
            GameController.getInstance().getAddressList();
    ...
    GameController.prototype.getHonorList = function () {
        var sendData = { token: GameModel.getInstance().getToken() };
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=user/get-ach-list', function (obj) {
            if (obj.status > 0) {
    ...
    GameController.prototype.getHonorReward = function (id) {
        ...
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=user/get-ach-gift', function (obj) {
    ...
    GameController.prototype.getYesterdayHarvestRank = function () {
        var sendData = { token: GameModel.getInstance().getToken() };
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=user/ranking-day-gold-list', function (obj) {
            if (obj.status > 0) {
    ...
    GameController.prototype.getYesterdayHarvestDetail = function () {
        var sendData = { token: GameModel.getInstance().getToken() };
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=user/get-my-ranking-day-gold-detail', function (obj) {
            if (obj.status > 0) {
    ...
    GameController.prototype.getContributeList = function (offset, page_count) {
        var sendData = { offset: offset, page_count: page_count, token: GameModel.getInstance().getToken() };
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=user/get-contribute-list', function (obj) {
            if (obj.status > 0) {
    ...
    GameController.prototype.getRankList = function (offset, page_count, by_gold) {
        ...
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=user/get-ranking-list', function (obj) {
            if (obj.status > 0) {
    ...
    GameController.prototype.getMyRankInAll = function (by_gold) {
        ...
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=friend/get-my-ranking', function (obj) {
    ...
    GameController.prototype.getMyRankInFriends = function (by_gold) {
        var sendData = { by_gold: by_gold, token: GameModel.getInstance().getToken() };
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=friend/my-ranking', function (obj) {
    ...
    GameController.prototype.getFriendList = function (offset, page_count, by_gold) {
        var sendData = { offset: offset, page_count: page_count, by_gold: by_gold, token: GameModel.getInstance().getToken() };
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=friend/get-friend-list', function (obj) {
            if (obj.status > 0) {
    ...
    GameController.prototype.findUser = function (search) {
        ...
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=friend/find', function (obj) {
            if (obj.status > 0) {
    ...
    GameController.prototype.addFriend = function (be_user_id) {
        ...
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=friend/add', function (obj) {
    ...
    GameController.prototype.getFriendRespondList = function () {
        var sendData = { token: GameModel.getInstance().getToken() };
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=friend/get-respond-list', function (obj) {
            if (obj.status > 0) {
    ...
    GameController.prototype.agreeOrRefuseAddFriend = function (be_user_id, is_agree) {
        ...
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=friend/respond', function (obj) {
    ...
    GameController.prototype.respondAddFriendList = function (be_user_id_list, is_agree) {
        ...
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=friend/respond-list', function (obj) {
    ...
    GameController.prototype.thumbsUp = function (be_user_id) {
        var sendData = { be_user_id: be_user_id, token: GameModel.getInstance().getToken() };
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=friend/thumbs-up', function (obj) {
    ...
    GameController.prototype.playGame = function () {
        var sendData = { token: GameModel.getInstance().getToken() };
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=user/play-game', function (obj) {
    ...
    GameController.prototype.getServerConfig = function () {
        var sendData = { token: GameModel.getInstance().getToken() };
        this.sendHttp(sendData, 'POST', this.serverAddress + '/frontend/web/index.php?r=comm/game-config', function (obj) {
